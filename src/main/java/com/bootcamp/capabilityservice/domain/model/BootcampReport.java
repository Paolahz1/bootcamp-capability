...
/**
 * Modelo de dominio para reportes de bootcamps almacenados en MongoDB.
 * Contiene datos desnormalizados para consultas rápidas de métricas y reportes.
 */
public class BootcampReport {
    ...
    private List<CapabilityWithTechnologies> capabilities;
    ...
    public BootcampReport(String id, Long bootcampId, String name, String description,
                          LocalDate startDate, LocalDate endDate, Integer capacityCount,
                          Integer technologyCount, Long enrollmentCount,
                          List<CapabilityWithTechnologies> capabilities,
    ...
    public List<CapabilityWithTechnologies> getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(List<CapabilityWithTechnologies> capabilities) {
